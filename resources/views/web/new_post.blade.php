                            ...
                            <div class="card mt-2" v-for="p in posts" style="margin-bottom:10px;">
                                ...
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" placeholder="Titulo" class="form-control" value="{{old('name')}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="">URL <span class="text-danger">*</span></label>
                                        <input type="text" name="slug" id="slug" placeholder="URL Amigable" class="form-control" readonly value="{{old('slug')}}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" id="category_id" class="form-control">
                                            ...
                                            <option value="{{$c->id}}" {{old('category_id') ? 'selected' : ''}}>{{$c->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label" for="tag_id{{$t->id}}"> <input class="form-check-input" type="checkbox"  name="tag_id[]" id="tag_id{{$t->id}}" value="{{$t->id}}"> {{$t->name}}</label>
                                        </div>
                                        @endforeach
                                    </div>

                                     <div class="form-group">
                                        <label for="" style="font-weight: bold;">Imagen <span class="text-danger">*</span></label><br>
